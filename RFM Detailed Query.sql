...
rfm_score as (
  select CustomerID, Country, r_score, fm_score, concat(r_score, fm_score) as rfm
  from scores
),
...
select r.CustomerID, r.Country, r.recency, r.frequency, r.monetary, s.rfm_segment, s.rfm
from r
